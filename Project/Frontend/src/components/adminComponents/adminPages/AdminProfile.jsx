        ...
        if (userData) {
          ...
          if (userId) {
            ...
            setUser({
              ...
              userID: fullUserData.userID || userId,
              id: fullUserData.userID || userId,
            });
            
            const updatedUserData = { ...parsedUser, ...fullUserData };
            ...
            <div className="card-body">
              <div className="d-flex flex-column flex-sm-row align-items-center gap-3">
                <div className="text-center">
                  ...
                  <small className="d-block mt-2 text-muted">Administrator</small>
                </div>

                <div className="flex-fill">
                  <h5 className="card-title mb-1">{`${user.firstName} ${user.lastName}`.trim() || "Administrator"}</h5>
